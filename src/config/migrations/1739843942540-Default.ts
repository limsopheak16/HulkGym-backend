...
export class Default1739843942540 implements MigrationInterface {
    name = 'Default1739843942540'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "company_info" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "logo" character varying NOT NULL, "company_name" character varying NOT NULL, "email" character varying NOT NULL, "location" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "modifiedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_88c3e323679d0747ffbb83f3f78" PRIMARY KEY ("id"))`);
